import { displaySimpleWindow, closePopupWindow, displayWindow } from "/src/scripts/popupWindow.js";
import { NotifTypes, newNotifForConnectedUsers } from "/src/scripts/notificationSystem.js";
...
document.getElementById("listingStatusButton").addEventListener("click", async () => {
    ...
    if (response.ok) {
        const notifType = buttonValue == "Unlist" ? NotifTypes.UNLISTED : NotifTypes.LISTING_AVAILABLE_AGAIN;
